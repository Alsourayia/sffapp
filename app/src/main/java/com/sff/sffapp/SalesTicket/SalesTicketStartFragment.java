...
public class SalesTicketStartFragment extends Fragment   implements View.OnClickListener   {
    ...
    TextView p8009_txt_cust_type  ,p8009_txt_loc_type , p8009_txt_channel  , p8009_txt_cntry  ,p8009_txt_city  , p8009_txt_district  , p8009_txt_ticket_type_desc ;
    JSONObject json ;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ((TextView)((SalesTicket) this.getActivity()).myToolbar.findViewById(R.id.toolbar_txt_title)).setText("Sales Ticket - start  ");
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.p8009_txt_ticket_type_desc) {
            ...
            spinnerDialog = new SpinnerDialog(this.getActivity(), "Select Ticket Type", "TICKETTYPE", "val2", this.getContext(), "8009", "");
            ...
            spinnerDialog = new SpinnerDialog(this.getActivity(), "Select or Search Customer Type", "CUSTTYPE", "val2", this.getContext(), "8009", "");
            spinnerDialog.bindOnSpinerListener(new OnSpinerItemClick() {
                @Override
                public void onClick(String item, int position, SoapObject obj) {
            ...
            spinnerDialog = new SpinnerDialog(this.getActivity(), "Select or Search Location Type", "LOCATIONTYPE", "val2", this.getContext(), "8009", "");
            spinnerDialog.bindOnSpinerListener(new OnSpinerItemClick() {
                @Override
                public void onClick(String item, int position, SoapObject obj) {
            ...
            spinnerDialog = new SpinnerDialog(this.getActivity(), "Select or Search Channel Type", "CONNECTIONTYPE", "val2", this.getContext(), "8009", "");
            spinnerDialog.bindOnSpinerListener(new OnSpinerItemClick() {
                @Override
                public void onClick(String item, int position, SoapObject obj) {
            ...
            spinnerDialog = new SpinnerDialog(this.getActivity(), "Select or Search Country", "CNTRY", "val2", this.getContext(), "8009", "");
            spinnerDialog.bindOnSpinerListener(new OnSpinerItemClick() {
                @Override
                public void onClick(String item, int position, SoapObject obj) {
            ...
            if (((SalesTicket) SalesTicketStartFragment.this.getActivity()).p8009_txt_cntry_val == null) {
                Toast.makeText(this.getContext(), "Must Select A Country", Toast.LENGTH_SHORT).show();
                ...
                try {
                    ...
                    spinnerDialog = new SpinnerDialog(this.getActivity(), "Select or Search Country", "CITY", "val2", this.getContext(), "8009", json.toString());
        ...
        {
            if (((SalesTicket) SalesTicketStartFragment.this.getActivity()).p8009_txt_cntry_val ==null  ){
                Toast.makeText(this.getContext(), "Must Select Country and City", Toast.LENGTH_SHORT).show();
                p8009_txt_cntry.requestFocus();
            }
            ...
            if ( ((SalesTicket) SalesTicketStartFragment.this.getActivity()).p8009_txt_city_val == null ){
                ...
                try
                {
                    ...
                    spinnerDialog = new SpinnerDialog(this.getActivity(), "Select or Search Country", "DISTRICTS", "val2", this.getContext(), "8009", json.toString());
