package com.example.aalsyyed.progbar;
...
import com.example.aalsyyed.progbar.components.StateItemDescription;
import com.example.aalsyyed.progbar.components.StateItemNumber;
import com.example.aalsyyed.progbar.listeners.OnStateItemClickListener;
import com.example.aalsyyed.progbar.utils.FontManager;
...
public class StateProgressBar extends View {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            ...
            mMaxStateNumber = 6 ;//a.getInteger(R.styleable.StateProgressBar_spb_maxStateNumber, mMaxStateNumber);
            ...
            mMaxDescriptionLine = 6 ; //a.getInteger(R.styleable.StateProgressBar_spb_maxDescriptionLines, mMaxDescriptionLine);
